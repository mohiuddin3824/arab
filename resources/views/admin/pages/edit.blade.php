...
<script src="https://cdn.tiny.cloud/1/r24p9oqicwy6ccj2ntw3q6u2jal1ex8hzk0fpu8qj7ys77ob/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
                        ...
                        <div class="card">
                            <div class="card-body"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="slug" value="{{$editPage->slug}}">
                                </div>
                                
                                <div class="form-group">
                                    <textarea id="pageEditEditor" name="description" rows="20" cols="80">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card mt-3">
                            <div class="card-body text-center">
                                <input type="submit" class="btn btn-lg btn-success" style="font-size: 20px" value="{{__('Update')}}">
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            tinymce.init({
            selector: 'textarea#pageEditEditor',
            height: 400,
            menubar: true,
            plugins: [
